  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
        {[
          { step: "١", title: "افتح مركز العروض", desc: "اضغط الزر أعلاه لعرض جميع العروض المتاحة" },
          { step: "٢", title: "أكمل عرضاً",       desc: "اختر عرضاً واتبع التعليمات حتى النهاية" },
          { step: "٣", title: "استلم نقاطك",      desc: "يُضاف رصيدك فور التحقق من الإتمام" },
        ].map(({ step, title, desc }) => (
          <div
            key={step}
